...
public class MemberManagementDemo {
	...
	public String console(String msg) {
		...
		Scanner sc = new Scanner(System.in); // Scanner(System.in); 키보드값 입력받기
		return sc.next();
	}
	...
	public void run(String index) {
		if (index.equals("1")) {
			...
			System.out.println("업데이트 후 프로그램 종료");
		} else {
	...
	// 1. 수정할 아이디를 입력받는다.
	// 2. ArrayList에 있는 멤버중에서 수정할 아이디를 찾아서 있으면 수정할 이름을 입력받고, ArrayList에 멤버정보를 수정하고 만약 없으면
	...
	// 1. 삭제할 아이디를 입력받는다.
	// 2. ArrayList에 있는 멤버중에서 삭제할 아이디를 찾아서 있으면 수정할 이름을 입력받고, ArrayList에 멤버정보를 삭제하고 만약 없으면
	// 	  삭제할 아이디가 없습니다. 라는 메세지를 출력한다.
	// 3. ArrayList에 있는 멤버정보를 모두 출력한다.
	// 4. print()메서드를 호출하여 번호를 선택할 수 있게 한다.
	// 5. 번호를 선택하세요> 메세지를 출력한 후 키보드 입력을 받게 대기한다.
	// 6. 번호를 입력받으면 run()메서드를 호출한다.
	...
	// 1. 검색할 아이디를 입력받는다.
	// 2. ArrayList에 있는 멤버중에서 검색할 아이디를 찾아서 있으면 출력하고, ArrayList에 멤버정보를 삭제하고 만약 없으면
	// 	  "검색된 결과가 없습니다." 라는 메세지를 출력한다.
